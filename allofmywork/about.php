<section class="about section" id="about">
    ...
    <div class="about__container container grid">
        <img src="img\Profile_Without_Face.jpg" alt="" class="about__img" />
        ...
        <div class="about__data">
            <p class="about__description">
                ...
                <br><br>
                > NATIONALITY: Singaporean <br><br>> LANGUAGES: English, Malay
            ...
            <div class="about__buttons">
                <a download="" href="https://drive.google.com/drive/folders/1i-AKIR8WeJUSSrv7Knjpa_yRCHPeBYJq?usp=sharing" class="button button--flex">
