        ...
        <div>
            ...
            <div class="skills__content skills__open">
                ...
                <div class="skills__list grid">
                    ...
                    <div class="skills__data">
                        ...
                        <div class="skills__bar">
                            <span class="skills__percentage skills__typescript"></span>
                        </div>
                    </div>
                    ...
                    <div class="skills__data">
                        <div class="skills__titles">
                            ...
                            <span class="skills__nuber">30%</span>
                        </div>
                        <div class="skills__bar">
                    ...
                    <div class="skills__data">
                        <div class="skills__titles">
                            <h3 class="skills__name">Shell Script</h3>
                            <span class="skills__nuber">30%</span>
                        </div>
                        <div class="skills__bar">
                            <span class="skills__percentage skills__shellscript"></span>
                        </div>
                    </div>
            ...
            <div class="skills__content skills__close">
                <div class="skills__header">
                    ...
                    <div>
                        <h1 class="skills__title">Operating System</h1>
                    </div>
                ...
                <div class="skills__list grid">
                    <div class="skills__data">
                        <div class="skills__titles">
                            <h3 class="skills__name">Windows</h3>
                            <span class="skills__nuber">80%</span>
                        </div>
                        <div class="skills__bar">
                            <span class="skills__percentage skills__windows"></span>
                        </div>
                    </div>
                    <div class="skills__data">
                        <div class="skills__titles">
                            <h3 class="skills__name">Linux - Ubuntu, Kali Linux, & Redhat</h3>
                    ...
                    <div class="skills__data">
                        <div class="skills__titles">
                            <h3 class="skills__name">Windows Server</h3>
                            <span class="skills__nuber">55%</span>
                        </div>
                        <div class="skills__bar">
                            <span class="skills__percentage skills__windowsserver"></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div>
            ...
            <div class="skills__content skills__close">
                ...
                <div class="skills__list grid">
                    ...
                    <div class="skills__data">
                        ...
                        <div class="skills__bar">
                            <span class="skills__percentage skills__awscloudservice"></span>
                        </div>
                    </div>
                    <div class="skills__data">
                        <div class="skills__titles">
                        ...
                        <div class="skills__bar">
                            <span class="skills__percentage skills__microsoftazure"></span>
                        </div>
                    </div>
                    <div class="skills__data">
                        <div class="skills__titles">
                            <h3 class="skills__name">IDS & IPS</h3>
            ...
            <div class="skills__content skills__close">
                ...
                <div class="skills__list grid">
                    <div class="skills__data">
                        <div class="skills__titles">
                            <h3 class="skills__name">Docker & Portainer</h3>
                            <span class="skills__nuber">60%</span>
                        </div>
                        <div class="skills__bar">
                            <span class="skills__percentage skills__DockPort"></span>
                        </div>
                    </div>
                    <div class="skills__data">
                        <div class="skills__titles">
                            <h3 class="skills__name">Grafana & Prometheus</h3>
                            <span class="skills__nuber">80%</span>
                        </div>
                        <div class="skills__bar">
                            <span class="skills__percentage skills__GraPro"></span>
                        </div>
                    </div>
                    <div class="skills__data">
                        <div class="skills__titles">
                            <h3 class="skills__name">Application Security</h3>
                            <span class="skills__nuber">60%</span>
                        </div>
                        <div class="skills__bar">
                            <span class="skills__percentage skills__AppSec"></span>
                        </div>
                    </div>
                    <div class="skills__data">
                        <div class="skills__titles">
                            <h3 class="skills__name">Digital Forensics</h3>
                            <span class="skills__nuber">75%</span>
                        </div>
                        <div class="skills__bar">
                            <span class="skills__percentage skills__DigiFor"></span>
                        </div>
                    </div>
                    <div class="skills__data">
                        <div class="skills__titles">
                            <h3 class="skills__name">Networking</h3>
                            <span class="skills__nuber">75%</span>
                        </div>
                        <div class="skills__bar">
